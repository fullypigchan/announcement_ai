...
| 기업규모 | 수출강도 | 기업수 | 1사평균 |
|---|---|---|---|
| 대기업 | 50–74% | 72 | **1,829,712** |
| 대기업 | 25–49% | 120 | 1,388,688 |
| 중견기업 | 75% 이상 | 124 | 315,629 |
| 중소기업 | 50–74% | 7,126 | 3,105 |
| **중소기업** | **1–24%** | **56,578** | **307** |

→ 모수는 중소기업 1–24% 구간(5.6만 개)이 압도, 1사평균 격차는 **약 5,964배**. **플랫폼이 묶어줘야 할 가치가 가장 큰 셀**.
...
| 산업 | 활동 | 신생률(%) |
|---|---|---|
| 도매 및 소매업 | 1,631,734 | 14.1 |
| 숙박 및 음식점업 | 916,804 | 15.7 |
| 제조업 | 560,551 | 6.1 |
| 전문과학기술서비스업 | 272,196 | 14.3 |
...
### 예측 데모 (재로드 후 smoke test)

| payment_amount | Actual (분) | Prediction (분) |
|---|---|---|
| 106,600 | 135,615 | 146,856 |
| 293,700 | 259,012 | 253,204 |
| 50,800 | 85,172 | 96,042 |
| 165,700 | 172,087 | 182,531 |
